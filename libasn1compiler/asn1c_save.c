...
asn1c_save_streams(arg_t *arg, asn1c_dep_chainset *deps, const char *destdir,
	...
	filename = strdup(asn1c_prefixed_filename(
		asn1c_make_identifier(AMI_MASK_ONLY_SPACES | AMI_NO_PREFIX, expr,
		                      (char*)0)));
	...
	header_id = asn1c_prefixed_filename(
		asn1c_make_identifier(AMI_NO_PREFIX, expr, NULL));
	safe_fprintf(fp_h,
		"#ifndef\t_%s_H_\n"
		"#define\t_%s_H_\n"
		"\n", header_id, header_id);
